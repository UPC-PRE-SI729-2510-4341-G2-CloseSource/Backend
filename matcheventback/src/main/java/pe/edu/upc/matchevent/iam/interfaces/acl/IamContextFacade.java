package pe.edu.upc.matchevent.iam.interfaces.acl;
...
import pe.edu.upc.matchevent.iam.domain.model.queries.GetUserByIdQuery;
import pe.edu.upc.matchevent.iam.domain.model.queries.GetUserByUsernameQuery;
import pe.edu.upc.matchevent.iam.domain.services.UserCommandService;
import pe.edu.upc.matchevent.iam.domain.services.UserQueryService;
...
public class IamContextFacade {
  ...
  /**
   * Verifica si el usuario con el userId tiene el rol especificado.
  ...
  public boolean userHasRole(Long userId, String roleName) {
    ...
    return optionalUser.get().getRoles().stream()
            .anyMatch(role -> role.getName() != null && role.getName().toString().equalsIgnoreCase(roleName));
